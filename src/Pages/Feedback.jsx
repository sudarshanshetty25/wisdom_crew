  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className=" p-10 rounded-3xl shadow-2xl w-full max-w-4xl space-y-6 border-4 border-dashed border-blue-400" >
        ...
        <label htmlFor="name" className="text-blue-700 font-semibold mb-4">Name:</label>
        <input
          type="text"
          id="name"
        ...
        <label htmlFor="usn" className="text-blue-700 font-semibold mb-4">USN:</label>
        <input
          type="text"
          id="usn"
        ...
        <label htmlFor="branch" className="text-blue-700 font-semibold mb-4">Branch:</label>
        <input
          type="text"
          id="branch"
        ...
        {/* File Upload Input */}
        <div className="mt-12">
          <label className="block text-xl font-semibold text-blue-700 mb-4" htmlFor="photo">
